      ...
      <div class="collapse navbar-collapse" id="navbarColor02">
        <ul class="navbar-nav mr-auto mb-2 mb-lg-0">
          <li class="nav-item active">
            <a class="nav-link" aria-current="page" href="<?= URL; ?>" id="linkPagIn">Página Inicial</a>
          </li>
          <li class="nav-item">
            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownManut" role="button" data-toggle="dropdown" aria-expanded="false">Consulta e Cadastro</a>
            <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdownManut" data-dropdown-in="fadeIn" data-dropdown-out="fadeOut" x-placement="bottom-start">
              <li><a class="dropdown-item" href="<?= URL; ?>lancamentos" id="linkLanc">Lançamento</a></li>
              <li><a class="dropdown-item" href="<?= URL; ?>tipo_lancamentos" id="linkTip">Tipo de Lançamento</a></li>
            </ul>
          </li>
        </ul>
        ...
        <ul class="navbar-nav d-flex flex-row">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right dropdown-info" aria-labelledby="userDropdown" data-dropdown-in="fadeIn" data-dropdown-out="fadeOut" x-placement="null">
              <a class="dropdown-item" href="<?= URL; ?>login" id="linkSair">Sair</a>
            </div>
          </li>
        </ul>
